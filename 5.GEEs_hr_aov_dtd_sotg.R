...
seq <- c(1:24, 26:33, 35:42, 44:51, 53:72) # Models 25,34,43,52 were not considered because they would include only the interactions between adults and chicks and no other variables, which would not be biologically relevant
